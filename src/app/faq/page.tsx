export default function Faq() {
    return (
        <section className="text-center">
            ...
            <div>
                <h2 className="text-3xl sm:text-4xl mt-8 text-blue-500">What can I donate?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                    Any wholesome food that you would gladly feed your loved ones.
                </p>
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">How can I donate food?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Do you accept expired food?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                    ...
                    and are mostly a way to encourage us to throw away perfectly good food and buy more. Please see this <a className="text-blue-500" href="https://www.usda.gov/about-usda/news/blog/save-money-knowing-when-food-safe">
                        USDA article
                    </a> to find out more. 
                </p>
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Can I cook up a big pan of something and put the whole thing in the fridge?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">How can I donate money?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">How can I help?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Where are your fridges located?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Isn't it hazardous for just anyone to be able to donate to the fridges and pantries?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Isn't there a liability issue?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Do you accept things other than food?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">What is mutual aid? How is it different from charity?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">How are community fridges different from food banks?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">Are there political or ideological ideas behind mutual aid and/or SCF?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">How often do you clean the fridges?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h2 className="text-3xl xm:text-4xl mt-8 text-blue-500">How does the organization work? Who's in charge?</h2>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
                ...
                <h1 className="text-3xl sm:text-4xl mt-8 font-SauceTomato text-blue-500">Seattle Community Fridge Community Understandings</h1>
                <p className="text-black text-lg w-2/3 mx-auto my-2">
